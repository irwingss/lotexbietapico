...
generar_texto_conclusiones <- function(muestra, celdas, locaciones, umbral, 
  ...
  texto <- paste0(
    ...
    "Proporción de puntos contaminados: Se estimó la proporción de puntos de muestreo dentro del polígono de cada celda cuyos valores de TPH superan el umbral de ",
    format(umbral, big.mark = ",", decimal.mark = "."), 
    ...
    "Proporción de puntos contaminados: Se estimó la proporción de puntos de muestreo dentro de los polígonos de cada locación cuyos valores de TPH superan el umbral de ",
    format(umbral, big.mark = ",", decimal.mark = "."), 
    ...
    if (n_locaciones_contaminadas > 0 && nchar(puntos_en_locs_contaminadas) > 0) 
      paste0("; exceptuando las rejillas de los puntos de muestreo de la locación ", locs_contaminadas_nombres, ": ", puntos_en_locs_contaminadas, ".") 
    else ".", "\n",
